...
def main():
	...
	questions_val = open(cwd+'/data/preprocessed/questions_val2014.txt', 
						'r').read().decode('utf8').splitlines()
	questions_lengths_val = open(cwd+'/data/preprocessed/questions_lengths_val2014.txt', 
								'r').read().decode('utf8').splitlines()
	answers_val = open(cwd+'/data/preprocessed/answers_val2014_all.txt', 
						'r').read().decode('utf8').splitlines()
	images_val = open(cwd+'/data/preprocessed/images_val2014_all.txt', 
						'r').read().decode('utf8').splitlines()
	...
	f1.close()
	f1 = open(cwd+'/results/overall_results.txt', 'a')
