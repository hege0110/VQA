...
def main():
	...
	questions_lengths_train = open(cwd+'/data/preprocessed/questions_lengths_train2014.txt', 'r').read().decode('utf8').splitlines()
	...
	model_file_name = cwd+'/models/lstm_1_num_hidden_units_lstm_' + str(args.num_hidden_units_lstm) + \
